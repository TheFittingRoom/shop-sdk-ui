    ...
    return `
            <form id="tfr-sign-in-form">
              ...
              <fieldset class="tfr-fieldset-element tfr-fieldset tfr-mt-20">
                  <legend tfr-element="true" class="tfr-label-element tfr-body-font tfr-14-default tfr-c-black-o5">${L.EmailAddress
      }</legend>
                  <input tfr-element="true" type="email" id="email-input" value="${email || ''}" />
              </fieldset>

              <fieldset class="tfr-fieldset-element tfr-fieldset tfr-mt-20">
                  <legend tfr-element="true" class="tfr-label-element tfr-body-font tfr-14-default tfr-c-black-o5">${L.Password
      }</legend>
              ...
              <div class="tfr-mt-20">
                  <span id="tfr-forgot-password" tfr-element="true" class="tfr-body-font tfr-14-default tfr-c-black-o5 tfr-underline tfr-cursor tfr-mr-15">${L.ForgotPasswordWithSymbol
      }</span>
                  <span id="tfr-scan-code" tfr-element="true" class="tfr-body-font tfr-14-default tfr-c-black-o5 tfr-underline tfr-cursor">${L.DontHaveAcc
      }</span>
              </div>
